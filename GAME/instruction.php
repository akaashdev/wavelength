        ...
        <div id="wrapper">
            ...
            <div id="main">
                ...
                <header id="header">
                    ...
                    <div id="cp">
                        <nav>
                            ...
                            <ul>
                                ...
                                <li><a href="#" class="icon fa-info"><span class="label">Email</span></a></li>
                    ...
                    <p>
                       <b> 1.</b> This is a Trial Hunt. It will run for 3 days with 3 questions per day.Questions will go live at 6p.m everyday.<br>
                       ...
                       <b> 5.</b> Case sensitivity isn't out thing.Also special characters. <br>
...
<b>7.</b> The point allocation is as follows: 20 points for each level <br>cracked from 6 p.m to 1.59 a.m;15 points from 2 a.m to 9.59 a.m; <br>10 points from 10 a.m to 5.59 p.m and 5 points thereafter.<br>
                        <b>8. </b>Top three will be awarded with a prize.<br>
